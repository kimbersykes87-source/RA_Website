// Photoshop Script: Export Ticketing Page Background Images (JPG Version)
...
var outputFolder = Folder("C:/dev/RubberArmstrongWebsite/main-site/images/ticketing");
var quality = 10; // JPG quality (0-12, where 10 = Maximum quality)

// Image configurations - maps source files to output prefixes
var imageTypes = [
    { sourceFile: "Ticketing-Hero.jpg", prefix: "Ticketing-Hero" },
    { sourceFile: "Ticketing-Steward.jpg", prefix: "Ticketing-Steward" }
];
...
// Main function
function exportAllTicketingImages() {
    var totalExported = 0;
    var errors = [];
    ...
    message += "• Ticketing-Hero-mobile.jpg (800×600)\n";
    message += "• Ticketing-Hero-tablet.jpg (1400×800)\n";
    message += "• Ticketing-Hero-desktop.jpg (2400×1200)\n\n";
    message += "• Ticketing-Steward-mobile.jpg (800×600)\n";
    message += "• Ticketing-Steward-tablet.jpg (1400×800)\n";
    message += "• Ticketing-Steward-desktop.jpg (2400×1200)\n\n";
    
    message += "💡 Note: Cloudflare will automatically convert these to WebP format for optimal performance.\n\n";
    
    if (totalExported === 6) {
        message += "✨ All Ticketing images ready for deployment!";
    }
